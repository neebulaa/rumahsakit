<?php 
$GLOBALS['title'] = 'EHealt | Tabel Poliklinik';
require_once "../functions.php";

EnsureUserAuth($conn, "php/poliklinik");
...
<div class="d-flex">
    ...
    <div class="container-fluid py-5 mx-5" style="overflow-y: auto; max-height: 100vh;">
        ...
        <p class="text-muted">Table managemen poliklinik EHealth</p>
            ...
            <?php if(count($datas) > 0): ?>
                <form action="" method="post" id="checked_form">
                    <table class="table table-striped table-bordered caption-top">
                        <caption>Saat ini <?= $total_datas ?> poliklinik.</caption>
                        <tr>
                            <th>
